...
public class PreprocessorLexer extends antlr.CharScanner implements PreprocessorTokenTypes, TokenStream
 {
	...
	private static final long _tokenSet_8_data_[] = { -8L, 6917529027641081855L, 0L, 0L };
	public static final BitSet _tokenSet_8 = new BitSet(_tokenSet_8_data_);
	private static final long _tokenSet_9_data_[] = { -576461319239106568L, 9223372036854775807L, 0L, 0L };
	public static final BitSet _tokenSet_9 = new BitSet(_tokenSet_9_data_);
	private static final long _tokenSet_10_data_[] = { -9224L, 9223372036854775807L, 0L, 0L };
	public static final BitSet _tokenSet_10 = new BitSet(_tokenSet_10_data_);
	private static final long _tokenSet_11_data_[] = { -4398046520328L, 9223372036854775807L, 0L, 0L };
...
public PreprocessorLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("tokens", this), new Integer(11));
	...
	public final void mASSIGN_RHS(boolean _createToken) throws ScannerException, IOException {
		...
		do {
			...
			case '~':
			{
				...
				_loop74:
				do {
					if ((_tokenSet_9.member(LA(1))) && ((LA(2) >= '\3' && LA(2) <= '~'))) {
						{
						match(_tokenSet_9);
						}
					}
					else {
						if ( _cnt74>=1 ) { break _loop74; } else {throw new ScannerException("no viable alt for char: "+(char)LA(1),getLine());}
					}
		...
		case '|':  case '}':  case '~':
		{
			...
			do {
				if ((_tokenSet_5.member(LA(1))) && ((LA(2) >= '\3' && LA(2) <= '~'))) {
					...
					if ( _cnt54>=1 ) { break _loop54; } else {throw new ScannerException("no viable alt for char: "+(char)LA(1),getLine());}
				}
 ...
 */
	public final void mID_OR_KEYWORD(boolean _createToken) throws ScannerException, IOException {
		...
		else if (((_tokenSet_7.member(LA(1))) && ((LA(2) >= '\3' && LA(2) <= '~')))&&(id.getText().equals("tokens"))) {
			{
			switch ( LA(1)) {
			case '\t':  case '\n':  case '\r':  case ' ':
			{
	...
	public final void mWS(boolean _createToken) throws ScannerException, IOException {
		...
		do {
			if ((LA(1)==' ')) {
				...
				if ( _cnt79>=1 ) { break _loop79; } else {throw new ScannerException("no viable alt for char: "+(char)LA(1),getLine());}
			}
