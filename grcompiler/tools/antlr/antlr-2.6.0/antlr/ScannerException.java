...
public class ScannerException extends ANTLRException {
	...
	/**
	 * @return the column number this exception occurred on.
	...
	/**
	 * @return a text string describing this error message.
	 * @author Shawn P. Vincent (svincent@svincent.com)
	 */
	 ...
	 * Modified by Shawn P. Vincent (svincent@svincent.com)
	 */
	public String toString() {
		return "line("+getLine ()+"), "+getErrorMessage();
	}
}