...
CPP2_PROJ=/Zc:wchar_t- /nologo /MT /W3 /GR /EHsc /O2 /I "./preprocessor" /D "GDLPP" /D "PKGDATADIR=''" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /c 
...
CPP2_PROJ=/nologo /MTd /W3 /Gm /GR /EHsc /RTC1 /ZI /Od /I "./preprocessor" /D "GDLPP" /D "PKGDATADIR=''" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /FR"$(INTDIR)\\" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /c 
