...
#pragma once
#endif
#ifndef UTILHASHMAP_H_INCLUDED
#define UTILHASHMAP_H_INCLUDED
//:End Ignore
...
public:
	...
	public:
		...
		iterator() : m_phmParent(0L), m_ihsnd(0)
		{
		}
	...
	iterator Begin();
	iterator End();
	void Insert(K & key, T & value, bool fOverwrite = false, int * pihsndOut = 0L);
