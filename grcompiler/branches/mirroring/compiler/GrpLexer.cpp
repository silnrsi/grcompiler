	...
	if ((LA(1)==static_cast<unsigned char>('0')) && (LA(2)==static_cast<unsigned char>('x'))) {
		...
		do {
			if ((_tokenSet_3.member(LA(1)))) {
				...
				if ( _cnt434>=1 ) { goto _loop434; } else {throw ScannerException(std::string("no viable alt for char: ")+charName(LA(1)),getLine());}
			}
		...
		do {
			if (((LA(1) >= static_cast<unsigned char>('0') && LA(1) <= static_cast<unsigned char>('9')))) {
				...
				if ( _cnt431>=1 ) { goto _loop431; } else {throw ScannerException(std::string("no viable alt for char: ")+charName(LA(1)),getLine());}
			}
...
void GrpLexer::mLIT_UHEX(bool _createToken) {
	...
	do {
		if ((_tokenSet_3.member(LA(1)))) {
			...
			if ( _cnt438>=1 ) { goto _loop438; } else {throw ScannerException(std::string("no viable alt for char: ")+charName(LA(1)),getLine());}
		}
