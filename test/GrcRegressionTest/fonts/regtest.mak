...
$(FONTS)\SchTest.ttf :
	$(GRCEXE)\grcompiler -v2 $(FONTS)\SchMain.gdl $(FONTS)\SchInput.ttf SchTest.ttf
    
$(FONTS)\CharisTest.ttf :
	$(GRCEXE)\grcompiler -v2 $(FONTS)\CharisMain.gdl $(FONTS)\CharisInput.ttf CharisTest.ttf
    
$(FONTS)\PigLatinTest_v2.ttf :
	$(GRCEXE)\grcompiler -v2 -p $(FONTS)\PigLatinMain.gdl $(FONTS)\PigLatinInput.ttf PigLatinTest_v2.ttf "PigLatin GrRegTest V2"
    
$(FONTS)\PigLatinTest_v3.ttf :
	$(GRCEXE)\grcompiler -v3 $(FONTS)\PigLatinMain.gdl $(FONTS)\PigLatinInput.ttf PigLatinTest_v3.ttf
    
$(FONTS)\PadaukTest.ttf :
	$(GRCEXE)\grcompiler -v3 -offsets -p $(FONTS)\PadaukMain.gdl $(FONTS)\PadaukInput.ttf PadaukTest.ttf
