...
[Files]
Source: "..\..\build\compiler\Debug\grcompiler.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\build\compiler\Debug\icuuc66.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\build\compiler\Debug\icudt66.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "..\..\build\preprocessor\Debug\gdlpp.exe"; DestDir: "{app}"; Flags: ignoreversion
